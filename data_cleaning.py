...
def filling_data_literate(df):
    df['Literate_Male'].fillna(0, inplace=True)
    df['Literate_Female'].fillna(0, inplace=True)
    df['Literate'].fillna(0, inplace=True)
...
collection = db["census_data"]  # Replace with your collection name
